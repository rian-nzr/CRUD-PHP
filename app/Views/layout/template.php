...
<body>
    ...
    <div class="md:h-16 h-28 mx-auto md:px-4 container flex items-center justify-between flex-wrap md:flex-nowrap">
      ...
      <div class="text-gray-500 order-3 w-full md:w-auto md:order-2">
        <ul class="flex font-semibold justify-between">
          ...
          <li class="md:px-4 md:py-2 hover:text-indigo-400"><a href="/komik/">komik</a></li>
          <li class="md:px-4 md:py-2 hover:text-indigo-400"><a href="/pages/about">About</a></li>
          <li class="md:px-4 md:py-2 hover:text-indigo-400"><a href="/pages/contact">Contact</a></li>
        </ul>
      </div>
  ...
  <footer class="text-gray-700 body-font bottom">
